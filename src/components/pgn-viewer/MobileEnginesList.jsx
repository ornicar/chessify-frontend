...
const MobileEnginesList = (props) => {
  ...
  return (
    <>
      <h6 className="mt-4 p-4 mb-main-engines-title">
        <b> You often use engines</b>
      </h6>
        ...
        return (
          ...
          >
            {engineList.map((engine, index) => {
              return (
                <div className="mb-engines-list-info" key={index}>
                  ...
                  {name !== 'stockfish10' && (
                    <div className="mb-analize-info-item-wrapper">
                      <DisplayEngineOption
                        engineName={name}
                        enginesOptionsList={enginesOptionsList}
                        handleOptionChange={handleOptionChange}
      ...
      <Accordion>
        <Accordion.Item eventKey="0" className="accordion-item">
          <Accordion.Button
            className="accordion-button mt-2"
            onClick={() => {
              setIsExpanded(!isExpanded);
            }}
          >
            <h6 className="mt-2 mb-2 pl-2">
              <b> More Engines</b>
            </h6>
            <div>
              {!isExpanded &&
